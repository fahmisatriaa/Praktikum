    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == "Add"){
                    ...
                    $.ajax({
                        url:"http://localhost/api.praktikum/api/employee/create.php",
                        method:"POST",
                    ...
                    $.ajax({
                        url:"http://localhost/api.praktikum/api/employee/update.php",
                        method:"PUT",
                        data: JSON.stringify(formData),
                        success:function(data){
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                    ...
                    url: "http://localhost/api.praktikum/api/employee/read.php",
        ...
        function showOne(id) {
            ...
            $.ajax({
                    type: "GET",
                    contentType: "application/json",
                    url: "http://localhost/api.praktikum/api/employee/read.php?id="+id,
                    success: function(response) { 
                        $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url:"http://localhost/api.praktikum/api/employee/delete.php",
                method:"DELETE",
